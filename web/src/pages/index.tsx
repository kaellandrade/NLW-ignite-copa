...
export default function Home(props: HomeProps) {
	...
	/**
	 * Chama a API para criar um bolão
	 */
		...
		<div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-20">
			<main>
				...
				<form className="mt-10 flex gap-2" onSubmit={createPool}>
					...
					<button
						type="submit"
						className="bg-yellow-500 px-6 py-4 rounded text-gray-900 font-bold font-sm uppercase hover:bg-yellow-700 transition ease-in-out"
					>
						Criar meu bolão
					</button>
				</form>
...
export const getServerSideProps = async () => {
	...
	return {
		props: {
			...
			userCount: userCountResponser.data.count
		}
	}
}
